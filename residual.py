...
def residual():
    ...
    plt.scatter(df['date'], lin_residuals, label='Linjär modell Residualer', s=6, color='blue')
    plt.scatter(df['date'], exp_residuals, label='Exponentiell modell Residualer', s=6, color='green')
    ...
    if lin_variance < exp_variance:
        print("Linjär modellen ger residualer med lägre varians än exponentiell modellen, så den kan vara lämpligare för data.")
    else:
        print("Exponentiell modellen ger residualer med lägre varians än linjär modellen, så den kan vara lämpligare för data.")
