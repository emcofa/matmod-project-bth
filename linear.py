...
def linear_regression():
    ...
    print(
        f"Punktskattningens konfidensintervall för a (Intercept) är {a_ci_lower:.3f} ± {a_ci_upper:.3f}"
    )
    b_ci_lower, b_ci_upper = conf_int[1]
    print(
        f"Punktskattningens konfidensintervall för b (date) är {b_ci_lower:.3f} ± {b_ci_upper:.3f}"
    )
    print(
        "-------------------------------------"
        "----------------------------------------"
    ...
    plt.fill_between(
        ...
        alpha=0.5,
        label="Konfidensintervall 95% Gladhammar",
    )
